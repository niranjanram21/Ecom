...
const Home = () => {
  ...
  <section className="mx-auto max-w-screen-2xl px-8 md:px-10">
    <div className="mb-8 flex flex-wrap justify-between md:mb-16">
      <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
        ...
        <div className="flex w-full flex-col gap-3 my-4 sm:flex-row sm:justify-center">
        <Link to="/login" className="inline-block rounded-lg bg-red-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-pink-500 transition duration-100 hover:bg-red-600 focus-visible:ring active:bg-red-700 md:text-base">Login</Link>
        <Link to="/signup" className="inline-block rounded-lg bg-red-100 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-pink-00 transition duration-100 hover:bg-red-200 focus-visible:ring active:text-red-700 md:text-base">Sign up</Link>
      </div>
      </div>

      <div className="mb-12 flex w-full md:mb-16 lg:w-2/3">
        <div className="relative left-12 top-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:ml-0">
          <img src={img1} loading="lazy" alt="Photo by Kaung Htet" className="h-full w-full object-cover object-center" />
        </div>

        <div className="overflow-hidden rounded-lg bg-gray-100 shadow-lg">
          <img src={img2} loading="lazy" alt="Photo by Manny Moreno" className="h-full w-full object-cover object-center" />
        </div>
      </div>
    </div>
